...
local Library do 
    ...
    Library = {
        ...
        Folders = {
            Directory = getgenv().FolderName,
            Configs = getgenv().FolderName .. "/Configs",
            Assets = getgenv().FolderName .. "/Assets",
            Fonts = getgenv().FolderName .. "/Fonts",
        },
    ...
    do
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["Side"] = Instances:Create("Frame", {
                    Name = "\0",
                    Size = UDim2.new(0.26667, 0, 0.89157, 0),
                    Position = UDim2.new(0, 176, 0, -16),
                    BackgroundColor3 = Color3.fromRGB(25, 24, 21),
                    BorderColor3 = Color3.fromRGB(25, 24, 21),
                    BorderSizePixel = 2,
                })
                ...
                Items["Pages"] = Instances:Create("Frame", {
                    ...
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, 0, 0.8, 0),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(25, 24, 21)
                })
        ...
        Library.Page = function(self, Data)
            ...
            local Page = {
                ...
                Icon = Data.Icon or Data.icon or "126152115075698",
        ...
        Library.Sections.Label = function(self, Name)
            ...
            function Label:SetText(Text)
                ...
                local ok, err = pcall(function()
                    if Items and Items["Text"] and Items["Text"].Instance and typeof(Items["Text"].Instance) == "Instance" then
    ...
    local function GetMainFrame()
        for _, gui in pairs(game:GetService("CoreGui"):GetDescendants()) do
            if gui.Name == "MainUIFrame" and gui:IsA("Frame") then
                return gui
            end
        end
        return nil
    ...
    local createUIButton = function()
        ...
        local function update(input)
            ...
            framee.Position = frame.Position
        end
                ...
                Callback = function()
                    if ConfigName and ConfigName ~= "" then
                        ...
                        if not isfile(filePath) then
                            ...
                            warn("Config already exists:", ConfigName)
                        end
                    end
                end
            })
                ...
                Callback = function()
                    if ConfigSelected then
                        ...
                        if isfile(filePath) then
                            ...
                            warn("Config file not found:", ConfigSelected)
                        end
                    end
                end
            })
            ...
            ConfigsSection:Button({
                ...
                Callback = function()
                    if ConfigSelected then
                        ...
                        AutoLoadLabel:SetText("Auto Load: " .. AutoLoadConfigName)
                        warn("Auto Load Config set to:", AutoLoadConfigName)
                    end
                end
            })
            ...
            local function AutoLoadConfig()
                if AutoLoadConfigName and AutoLoadConfigName ~= "" then
                    ...
                    if isfile(filePath) then
                        ...
                        warn("Auto load config not found:", AutoLoadConfigName)
                    end
                end
            end
